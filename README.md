...
[![Download EXE](https://img.shields.io/badge/Download-UltraLightBrowser.exe-success?style=flat&logo=windows)](https://github.com/Freecode100Year/UltraLightBrowser/releases/download/v1.1.0/UltraLightBrowser.exe)
...
* 🚀 **[下载独立可执行程序 (UltraLightBrowser.exe)](https://github.com/Freecode100Year/UltraLightBrowser/releases/download/v1.1.0/UltraLightBrowser.exe)**（推荐：单文件，双击即用）
* 📦 **[下载便携完整压缩包 (UltraLightBrowser-v1.1.0-windows-x64.zip)](https://github.com/Freecode100Year/UltraLightBrowser/releases/download/v1.1.0/UltraLightBrowser-v1.1.0-windows-x64.zip)**
